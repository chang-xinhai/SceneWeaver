...
def main():
    parser = argparse.ArgumentParser(description='Send commands to Blender socket server')
...
if __name__ == "__main__":
    ...
    print("   python socket_client_example.py --action init_physcene --iter 0 --save_dir debug/")
    print()
    print("3. Initialize metascene:")
    print("   python socket_client_example.py --action init_metascene --iter 0 --save_dir debug/")
    print()
    print("4. Stop server:")
