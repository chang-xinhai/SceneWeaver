...
def delete_empty_objects(empty_parents):
    # Iterate through all objects in the scene
    for obj in empty_parents:
...
def delete_empty_object(empty_parent):
    # Iterate through all objects in the scene
    obj = empty_parent
    # Check if the object is empty (has no geometry)
    print(obj.name, obj.type)
...
if __name__ == "__main__":
    ...
    for OBJS in MSH_OBJS:
        ...
        object_rotation_z = (
            item["rotation"]["z_angle"] / 180.0
        ) * math.pi + math.pi  # Rotation angles in radians around the X, Y, and Z axes
