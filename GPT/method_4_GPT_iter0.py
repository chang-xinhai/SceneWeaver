...
def generate_scene_iter0(user_demand):
    ...
    user_prompt = prompts.step_1_big_object_prompt_user.format(demand=user_demand)
    ...
    system_prompt = prompts.step_3_class_name_prompt_system.format(
        demand=user_demand
    )
    ...
    with open(f"method_4_GPT_iter0_results.json", "w") as f:
